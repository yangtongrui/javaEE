...
<HEAD>
	...
	<script type="text/javascript">
       function addMed(){
            window.location.href = "Med_typeServlet";
        }
        function delMed(mid) {
            var b = confirm("您确定要删除吗？");
            if(b){
                window.location.href = "/MeddelServlet?mid="+mid;
			}
        }
		...
		<tr>
			<td class="ta_01" align="right">
				<button type="button" id="add" name="add" value="添加"
						class="button_add" onclick="addMed()">
					&#28155;&#21152;</button>
					...
					<c:forEach items="${medList}" var="med">
						<tr onmouseover="this.style.backgroundColor = 'white'"
							...
							<td align="center" style="HEIGHT: 22px"  ><a
									href="${ pageContext.request.contextPath }InsertMedServlet?mid=${med.mid}" >
								<img
										src="${pageContext.request.contextPath}/images/i_edit.gif"
										border="0" style="CURSOR: hand" >
							</a></td>
							<td align="center" style="HEIGHT: 22px"><a href="#" onclick="delMed('${med.mid}');">
								<img
